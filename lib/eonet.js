  ...
  return {
    events: function events() {
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        return (0, _util.sendRequest)(endpoint, options, function (err, data) {
    ...
    sources: function sources() {
      return new _promise2.default(function (resolve, reject) {
        return (0, _util.sendRequest)('https://eonet.sci.gsfc.nasa.gov/api/v2.1/sources', {}, function (err, data) {
          if (err) return reject(err);
          return resolve(data);
        });
      });
