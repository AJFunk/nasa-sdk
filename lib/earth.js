  ...
  return {
    imagery: function imagery() {
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        return (0, _util.sendRequest)('api.nasa.gov', '/planetary/earth/imagery', options, function (err, data) {
    ...
    assets: function assets() {
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        return (0, _util.sendRequest)('api.nasa.gov', '/planetary/earth/assets', options, function (err, data) {
          if (err) return reject(err);
          return resolve(data);
        });
      });
