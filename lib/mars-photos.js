  ...
  return {
    ...
    fetch: function fetch(rover) {
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        return (0, _util.sendRequest)('api.nasa.gov', '/mars-photos/api/v1/rovers/' + validRover + '/photos', (0, _assign2.default)({}, options, { camera: validCamera }), function (err, data) {
    ...
    manifest: function manifest(rover) {
      return new _promise2.default(function (resolve, reject) {
        ...
        var validRover = validateRover(rover);
        if (!validRover) return reject(new Error('Invalid rover name'));
        return (0, _util.sendRequest)('api.nasa.gov', '/mars-photos/api/v1/manifests/' + validRover, {}, function (err, data) {
          if (err) return reject(err);
          return data ? resolve(data) : reject(new Error('No data found'));
        });
      });
