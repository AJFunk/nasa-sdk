  ...
  return {
    fetch: function fetch(type) {
      return new _promise2.default(function (resolve, reject) {
        ...
        return (0, _util.sendRequest)('https://api.nasa.gov/EPIC/api/' + validType, {}, function (err, data) {
    ...
    date: function date(type, _date) {
      return new _promise2.default(function (resolve, reject) {
        ...
        return (0, _util.sendRequest)('https://api.nasa.gov/EPIC/api/' + type + '/date/' + _date, {}, function (err, data) {
          if (err) return reject(err);
          return resolve(data);
        });
      });
    ...
    all: function all(type) {
      return new _promise2.default(function (resolve, reject) {
        ...
        var validType = validateType(type);
        if (!validType) return reject('Invalid image quality type');
        return (0, _util.sendRequest)('https://api.nasa.gov/EPIC/api/' + type + '/all', {}, function (err, data) {
          if (err) return reject(err);
          return resolve(data);
        });
      });
    ...
    available: function available(type) {
      return new _promise2.default(function (resolve, reject) {
        ...
        var validType = validateType(type);
        if (!validType) return reject('Invalid image quality type');
        return (0, _util.sendRequest)('https://api.nasa.gov/EPIC/api/' + type + '/available', {}, function (err, data) {
          if (err) return reject(err);
          return resolve(data);
        });
      });
